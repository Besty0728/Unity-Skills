...
通过 REST API 让 AI 直接控制 Unity 编辑器。731 个 REST Skills + 20 个 Advisory 模块。
...
│   │   │   └── *Skills.cs × 51           # 功能模块 (共 731 Skills)
