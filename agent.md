...
通过 REST API 让 AI 直接控制 Unity 编辑器。771 个 REST Skills + 23 个 Advisory 模块。
...
│   │   │   └── *Skills.cs × 52           # 功能模块 (共 771 Skills)
