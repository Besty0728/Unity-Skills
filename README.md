...
- 🛠️ **784 REST Skills Comprehensive Toolkit**: Includes 54 functional source modules plus 25 advisory design modules, with Batch operations for multi-object control.
- ⚡ **Revolutionary Efficiency Boost (v2.0.1+)**: Schema caching + exponential backoff polling + BATCH-FIRST guidance → **Token consumption ↓ 96%**, **simple tasks 4-6 calls → 1 call (↓ 75-83%)**. Current: v2.5.0.
...
>
> 25 advisory design modules (architecture, performance, design patterns, testability, package-specific source rules, etc.) are available in all modes and loaded on demand.
...
>
> 🧠 `unity-skills/skills/` also includes **25 advisory design modules** for architecture, script design, performance, maintainability, Inspector guidance, and package-specific source rules.
...
│   │   ├── skills/                 # 75 module docs (50 REST/module docs + 25 advisory docs)
