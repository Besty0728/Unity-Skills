...
namespace UnitySkills
{
    ...
    public static class SkillsLocalization
    {
        ...
        private static readonly Dictionary<string, string> _english = new Dictionary<string, string>
        {
            ...
            {"macro_topbar_tooltip", "Open Macro Recorder"},
            ...
            {"shortcut_btn_apply", "Apply"},
            {"shortcut_btn_cancel", "Cancel"},
            ...
            // ===== Macro Recorder panel (v2.1) =====
            {"shortcut_cmd_open_macro", "Open Macro Recorder"},
            {"macro_window_title", "Macro Recorder"},
            {"macro_btn_record", "Record"},
            {"macro_btn_stop", "Stop"},
            {"macro_status_idle", "Not recording"},
            {"macro_status_recording_fmt", "Recording — {0} record(s) · {1}"},
            {"macro_status_stopped_fmt", "Stopped — {0} record(s)"},
            {"macro_stopped_buffer_full", "buffer full, auto-stopped"},
            {"macro_interrupted_hint", "The last recording was interrupted by a domain reload (script compile / play mode) and was discarded."},
            {"macro_undo_redo_hint", "Undo/Redo was used during this recording; the exported sequence may not replay the exact history."},
            {"macro_ignore_rest_toggle", "Ignore REST changes"},
            {"macro_ignore_rest_tooltip", "While recording, skip scene changes made by REST skill calls (only manual editor operations are captured)."},
            {"macro_coverage_fmt", "Invertible {0} / Partial {1} / Unsupported {2}  (of {3})"},
            {"macro_btn_export_file", "Export Macro File"},
            {"macro_btn_copy_json", "Copy Batch JSON"},
            {"macro_btn_import_file", "Import Macro File"},
            {"macro_btn_replay", "Replay"},
            {"macro_btn_replay_run", "Run Replay"},
            {"macro_params_label", "Replay params (JSON, fills $param slots)"},
            {"macro_source_session", "Source: current session"},
            {"macro_source_file_fmt", "Source: {0} ({1} steps)"},
            {"macro_source_none", "No exportable session — record something first"},
            {"macro_server_not_running", "The Skills server is not running. Start it in the main UnitySkills panel first."},
            {"macro_replay_running", "Replaying…"},
            {"macro_replay_result_fmt", "Replay {0}: executed {1}, failed {2}"},
            {"macro_replay_rolled_back", "rolled back"},
            {"macro_replay_failed_steps", "Failed steps (first {0}):"},
            {"macro_replay_request_failed_fmt", "Replay request failed: {0}"},
            {"macro_params_invalid", "Replay params must be a JSON object, e.g. {\"height\": 3}."},
            {"macro_export_saved_fmt", "Macro saved: {0}"},
            {"macro_export_failed_fmt", "Export failed: {0}"},
            {"macro_import_failed_fmt", "Import failed: {0}"},
            {"macro_copied", "Batch JSON copied to clipboard."},
            {"macro_kind_create", "Create"},
            {"macro_kind_destroy", "Delete"},
            {"macro_kind_reparent", "Reparent"},
            {"macro_kind_structure", "Components"},
            {"macro_kind_property", "Property"},
            {"macro_kind_reorder", "Reorder"},
            {"macro_inv_ok_tip", "Invertible: replays via /skills/batch"},
            {"macro_inv_partial_tip_fmt", "Partially invertible: {0}"},
            {"macro_inv_unsupported_tip_fmt", "Not invertible: {0}"},
            {"macro_inv_reason_component_removal", "ambiguous removal: another instance of the same component type remains"},
            {"macro_inv_reason_rect_transform", "RectTransform is recreated as a plain GameObject"},
            {"macro_inv_reason_prefab_missing", "the prefab asset does not exist in this project"},
            {"macro_inv_reason_prefab_nonroot", "non-root part of a prefab instance"},
            {"macro_inv_reason_create_unresolvable", "object no longer resolvable"},
            {"macro_inv_reason_destroy_no_identity", "the destroyed object could not be identified"},
            {"macro_inv_reason_go_property", "this GameObject-level property has no inverse skill"},
            {"macro_inv_reason_scene_ref_unresolved", "references a scene object that could not be resolved"},
            {"macro_dialog_ok", "OK"},
        };
        ...
        private static readonly Dictionary<string, string> _chinese = new Dictionary<string, string>
        {
            ...
            {"shortcut_btn_apply", "应用"},
            {"shortcut_btn_cancel", "取消"},
            ...
            // ===== Macro Recorder panel (v2.1) =====
            {"shortcut_cmd_open_macro", "打开宏录制面板"},
            {"macro_window_title", "宏录制"},
            {"macro_btn_record", "开始录制"},
            {"macro_btn_stop", "停止录制"},
            {"macro_status_idle", "未在录制"},
            {"macro_status_recording_fmt", "录制中 — 已录 {0} 条 · {1}"},
            {"macro_status_stopped_fmt", "已停止 — 共 {0} 条"},
            {"macro_stopped_buffer_full", "缓冲区已满，自动停止"},
            {"macro_interrupted_hint", "上次录制被 Domain Reload（脚本编译/进入播放模式）中断，会话已丢弃。"},
            {"macro_undo_redo_hint", "录制期间使用过撤销/重做，导出序列可能无法完全重放原始操作历史。"},
            {"macro_ignore_rest_toggle", "忽略 REST 造成的变化"},
            {"macro_ignore_rest_tooltip", "录制时跳过 REST 技能调用产生的场景变化（只记录手工编辑器操作）。"},
            {"macro_coverage_fmt", "可反演 {0} / 部分 {1} / 不支持 {2}（共 {3}）"},
            {"macro_btn_export_file", "导出宏文件"},
            {"macro_btn_copy_json", "复制 Batch JSON"},
            {"macro_btn_import_file", "导入宏文件"},
            {"macro_btn_replay", "重放"},
            {"macro_btn_replay_run", "执行重放"},
            {"macro_params_label", "重放参数（JSON，填充 $param 槽位）"},
            {"macro_source_session", "来源：当前会话"},
            {"macro_source_file_fmt", "来源：{0}（{1} 步）"},
            {"macro_source_none", "暂无可导出的会话——请先录制"},
            {"macro_server_not_running", "Skills 服务未运行，请先在 UnitySkills 主面板启动服务器。"},
            {"macro_replay_running", "重放中…"},
            {"macro_replay_result_fmt", "重放 {0}：成功 {1} 步，失败 {2} 步"},
            {"macro_replay_rolled_back", "已回滚"},
            {"macro_replay_failed_steps", "失败步骤（前 {0} 条）："},
            {"macro_replay_request_failed_fmt", "重放请求失败：{0}"},
            {"macro_params_invalid", "重放参数必须是 JSON 对象，例如 {\"height\": 3}。"},
            {"macro_export_saved_fmt", "宏已保存：{0}"},
            {"macro_export_failed_fmt", "导出失败：{0}"},
            {"macro_import_failed_fmt", "导入失败：{0}"},
            {"macro_copied", "Batch JSON 已复制到剪贴板。"},
            {"macro_kind_create", "创建"},
            {"macro_kind_destroy", "删除"},
            {"macro_kind_reparent", "移动父级"},
            {"macro_kind_structure", "组件"},
            {"macro_kind_property", "属性"},
            {"macro_kind_reorder", "排序"},
            {"macro_inv_ok_tip", "可反演：可经 /skills/batch 重放"},
            {"macro_inv_partial_tip_fmt", "部分可反演：{0}"},
            {"macro_inv_unsupported_tip_fmt", "不可反演：{0}"},
            {"macro_inv_reason_component_removal", "移除存在歧义：对象上仍有同类型组件实例"},
            {"macro_inv_reason_rect_transform", "RectTransform 将以普通 GameObject 重建"},
            {"macro_inv_reason_prefab_missing", "本项目中不存在该 Prefab 资产"},
            {"macro_inv_reason_prefab_nonroot", "Prefab 实例的非根部分"},
            {"macro_inv_reason_create_unresolvable", "对象已无法解析"},
            {"macro_inv_reason_destroy_no_identity", "无法识别被删除的对象"},
            {"macro_inv_reason_go_property", "该 GameObject 级属性没有反演技能"},
            {"macro_inv_reason_scene_ref_unresolved", "引用的场景对象无法解析"},
            {"macro_dialog_ok", "知道了"},
        };
    }
}
